...
class Platform
{
	...
	// public static function makeLocale($language, $countryIsoCode2, $ip='')
	// {
	// 	$lang = self::getBrowserLanguage($language);
				
	// 	$Geo = new SB_Geoplugin();
	// 	$Geo->search($ip);
	// 	$country = $Geo->getCountryCode($countryIsoCode2);

	// 	return substr($lang,0,2) . '-' . $country;	
	// }
